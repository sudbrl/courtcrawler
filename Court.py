...
end_date_str = st.text_input("Enter End Date (YYYY-MM-DD)")
    ...
    if not start_date_str or not end_date_str:
        ...
        try:
            ...
            with st.spinner("Fetching data..."):
                table_data = asyncio.run(get_table_data(start_date, end_date, court_type, court_id))
